  ...
  return (
    <PortalLayout activeSection="datos-abiertos">
      <div className="p-6 lg:p-12 max-w-6xl mx-auto">
        <h1 className="text-3xl lg:text-4xl font-bold text-foreground mb-3 text-balance">Política de Datos Abiertos</h1>
        <p className="text-lg text-muted-foreground mb-8 text-pretty">
          Acceso libre y reutilización de datos fiscales del Estado de Morelos en formatos abiertos y estándares
          internacionales.
        </p>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="grid gap-3 sm:grid-cols-3">
              ...
              <div className="rounded-lg border p-4">
                ...
                <p className="text-sm text-muted-foreground">Sin restricciones de uso o licencia</p>
              </div>
              <div className="rounded-lg border p-4">
