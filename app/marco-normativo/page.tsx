  ...
  return (
    <PortalLayout activeSection="marco-normativo">
      <div className="p-6 lg:p-12 max-w-6xl mx-auto">
        <h1 className="text-3xl lg:text-4xl font-bold text-foreground mb-3 text-balance">Marco Normativo</h1>
        <p className="text-lg text-muted-foreground mb-8 text-pretty">
          El Portal de Transparencia Fiscal del Estado de Morelos se fundamenta en un robusto marco jurídico federal y
          estatal que obliga a transparentar la información relacionada con las finanzas públicas.
        </p>
