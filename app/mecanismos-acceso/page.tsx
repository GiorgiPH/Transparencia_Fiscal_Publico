  ...
  return (
    <PortalLayout activeSection="mecanismos">
      <div className="p-6 lg:p-12 max-w-6xl mx-auto">
        <h1 className="text-3xl lg:text-4xl font-bold text-foreground mb-3 text-balance">Mecanismos de Acceso</h1>
        <p className="text-lg text-muted-foreground mb-8 text-pretty">
          El Portal de Transparencia Fiscal del Estado de Morelos es una herramienta fundamental para garantizar el
          acceso a la información financiera pública.
        </p>
