...
const sections = [
  { id: "finanzas", label: "Información de Finanzas Públicas", icon: BarChart3, href: "/finanzas" },
  { id: "mecanismos", label: "Mecanismos de Acceso", icon: Lock, href: "/mecanismos-acceso" },
  { id: "participacion", label: "Participación Ciudadana", icon: Users, href: "/participacion-ciudadana" },
  ...
  { id: "marco-normativo", label: "Marco Normativo", icon: Scale, href: "/marco-normativo" },
  { id: "busqueda-documentos", label: "Búsqueda de Datos y Documentos", icon: Search, href: "/busqueda-documentos" },
]
